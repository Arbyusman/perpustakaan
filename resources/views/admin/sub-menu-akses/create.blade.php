            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <form class="form"
                            action="{{ route('submenu_access.store', ['role_id' => Crypt::encrypt($role->id), 'menu_id' => Crypt::encrypt($menu->id)]) }}"
                            method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" placeholder="Nama Menu"
                                                name="name" value="{{ $menu->name }}" disabled>
                                        </div>
                                    </div>

                                    <div class="form-group @if ($errors->has('sub_menu_id')) has-error @endif">
                                        <label class="col-sm-2 control-label">{{ __('Sub Menu') }} <span
                                                class="required" style="color: #dd4b39;">*</span></label>
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control" name="sub_menu_id">
                                                ...
                                                @foreach ($sub_menu as $v)
                                                    <option value="{{ $v->id }}"
                                                        @if (old('sub_menu_id') == $v->id) selected @endif>
                                                        {{ $v->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group @if ($errors->has('create')) has-error @endif">
                                        <label class="col-sm-2 control-label">{{ __('Create') }} <span
                                                class="required" style="color: #dd4b39;">*</span></label>
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control" name="create">
                                                ...
                                                <option value="1"
                                                    @if (old('create') == '1') selected @endif>
                                                    Aktif</option>
                                                <option value="0"
                                                    @if (old('create') == '0') selected @endif>
                                                    Tidak Aktif</option>
                                            </select>
                                    ...
                                    <div class="form-group @if ($errors->has('read')) has-error @endif">
                                        <label class="col-sm-2 control-label">{{ __('Read') }} <span
                                                class="required" style="color: #dd4b39;">*</span></label>
                                        <div class="col-sm-12">
                                            @if ($errors->has('read'))
                                                <label class="control-label" for="inputError"><i
                                            ...
                                            <select class="form-control" name="read">
                                                <option value="">- Pilih -</option>
                                                <option value="1"
                                                    @if (old('read') == '1') selected @endif>
                                                    Aktif</option>
                                                <option value="0"
                                                    @if (old('read') == '0') selected @endif>
                                                    Tidak Aktif</option>
                                            </select>
                                    ...
                                    <div class="form-group @if ($errors->has('update')) has-error @endif">
                                        <label class="col-sm-2 control-label">{{ __('Update') }} <span
                                                class="required" style="color: #dd4b39;">*</span></label>
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control" name="update">
                                                <option value="">- Pilih -</option>
                                                <option value="1"
                                                    @if (old('update') == '1') selected @endif>
                                                    Aktif</option>
                                                <option value="0"
                                                    @if (old('update') == '0') selected @endif>
                                                    Tidak Aktif</option>
                                            </select>
                                    ...
                                    <div class="form-group @if ($errors->has('delete')) has-error @endif">
                                        <label class="col-sm-2 control-label">{{ __('Delete') }} <span
                                                class="required" style="color: #dd4b39;">*</span></label>
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control" name="delete">
                                                <option value="">- Pilih -</option>
                                                <option value="1"
                                                    @if (old('delete') == '1') selected @endif>
                                                    Aktif</option>
                                                <option value="0"
                                                    @if (old('delete') == '0') selected @endif>
                                                    Tidak Aktif</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <button type="submit" class="btn btn-primary btn-flat btn-sm"
                                                title="Tambah Data"> Simpan</button>
