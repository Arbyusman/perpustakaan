...
<div class="app-navbar flex-shrink-0">
	...
	<div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
		<!--begin::Menu wrapper-->
		<div class="cursor-pointer symbol symbol-30px symbol-md-40px border border-3" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
			<img src="{{ Auth::user()->avatar ? asset('storage/images/' . Auth::user()->avatar) : asset('assets/media/svg/files/blank-image.svg') }}" alt="user" />
		</div>
