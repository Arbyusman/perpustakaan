...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
    <!--begin::Logo image-->
    <a href="/">
        <img alt="Logo" src="{{ asset('storage/images/' . $setting->small_icon) ? asset('storage/images/' . $setting->small_icon) : image('logos/default-dark.svg') }}"
            class="h-50px app-sidebar-logo-default" />
        <img alt="Logo"
            src="{{ asset('storage/images/' . $setting->small_icon) ? asset('storage/images/' . $setting->small_icon) : image('logos/default-small.svg') }}"
