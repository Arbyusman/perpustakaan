...
<div class="s overflow-hidden flex-column-fluid">
    ...
    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true"
            ...
            <!--begin:Menu item-->
            @if (WebHelpers::masterDataMenu()->count() >= 1)
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                <!--begin:Menu link-->
                @foreach (WebHelpers::masterDataMenu() as $itemMasteMenu)
                    <!--end:Menu link-->
                    <!--begin:Menu sub-->

                    @if ($itemMasteMenu->link == '#')
                        <span class="menu-link">
                            <span class="menu-icon">{!! getIcon('{{ $itemMasteMenu->attribute }}', 'fs-2') !!}</span>
                            <span class="menu-title">{{ $itemMasteMenu->name }}</span>
                            {{-- <span class="menu-arrow"></span> --}}
                        </span>
                        <div class="menu-sub menu-sub-accordion">
                            <!--begin:Menu item-->
                            @foreach (WebHelpers::submenu($itemMasteMenu->id) as $itemMasterSubMenu)
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ $itemMasterSubMenu->link }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ $itemMasterSubMenu->name }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                            @endforeach
                    ...
                    @else
                        <div class="menu-item">
                            <a class="menu-link " href="{{ $itemMasteMenu->link }}">
                                <span class="menu-icon">{!! getIcon('{{ $itemMasteMenu->attribute }}', 'fs-2') !!}</span>
                                <span class="menu-title">{{ $itemMasteMenu->name }}</span>
                                {{-- <span class="menu-arrow"></span> --}}
                            </a>
            ...
            <!--begin:Menu item-->
            @if (WebHelpers::settingMenu()->count() >= 1)
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                <!--begin:Menu link-->
                @foreach (WebHelpers::settingMenu() as $itemSettingMenu)
                    <!--end:Menu link-->
                    <!--begin:Menu sub-->

                    @if ($itemSettingMenu->link == '#')
                        <span class="menu-link">
                            <span class="menu-icon">{!! getIcon('{{ $itemSettingMenu->attribute }}', 'fs-2') !!}</span>
                            <span class="menu-title">{{ $itemSettingMenu->name }}</span>
                            {{-- <span class="menu-arrow"></span> --}}
                        </span>
                        <div class="menu-sub menu-sub-accordion">
                            <!--begin:Menu item-->
                            @foreach (WebHelpers::submenu($itemSettingMenu->id) as $itemSettingSubMenu)
                                <div class="menu-item">
                                    {{-- @dd($itemSettingSubMenu) --}}
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="{{ $itemSettingSubMenu->link }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ $itemSettingSubMenu->name ?? 'N/A' }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                            @endforeach
                    ...
                    @else
                        <div class="menu-item">
                            <a class="menu-link " href="{{ $itemSettingMenu->link }}">
                                <span class="menu-icon">{!! getIcon('{{ $itemSettingMenu->attribute }}', 'fs-2') !!}</span>
                                <span class="menu-title">{{ $itemSettingMenu->name }}</span>
                                {{-- <span class="menu-arrow"></span> --}}
                            </a>
